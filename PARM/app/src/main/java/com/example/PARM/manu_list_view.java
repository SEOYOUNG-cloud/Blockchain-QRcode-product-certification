...
public class manu_list_view extends AppCompatActivity {
    ...
    private static String TAG = "manu_BusinessListView";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        task.execute( "http://" + "13.125.1.15" + ":8080/api/getFactoryID?factory=" + B_name, "");
